...
const API = { getTasks,getImportantTasks, getTodayTasks,getWeeklyTasks,getPrivateTasks,getSharedTasks, getByProject,updateTask, addTask,deleteTask,isToday,isNextWeek} ;
export default API;
