...
loop: lb R3,v(R1) ;                            FDEMW (+1                            load di v(i)
      ...
      cic: andi R6,R5,1 ;                           FDEMW (+1                       and del risultato con 1 --> se 1 ho un uno, altrimenti no
           dadd R7,R7,R6 ;                           FDEMW +1                       sommo il risultato della and al contatore di 1 (non necessita di condizioni)
      ...
      dadd R9,R9,R6 ;                                     FDEMW +1                  sommo il risultato della and al contatore dei dispari (non necessita di condizioni)
     bne R1,R2,loop ;                                      FDEMW +1 +1)=4 +        cond. per ciclo esterno
     daddi R2,R2,-1 ;                                       FDEMW +1
     dsub R8,R2,R9 ;                                         FDEMW +1               calcolo contatore dei pari come differenza tra il numero di valori e il numero di dispari
