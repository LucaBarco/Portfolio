...
extern int nbutton; //indica quale bottone è premuto sul touch screen (se nessuno è 0)
extern int note1,note2; //indici per accedere al vettore delle note (frequenze+messaggi)
static char NameNote[14][12]={
	...
	"277 Hz - Db",
	"262 Hz - C",
	"           "}; //matrice dei messaggi da stampare
...
void TurnOnPanel(void){
	//funzione che disegna display standard con un pulsante di accensione
	int x0,y0;
	LCD_Clear(Black);
	x0=180;
	y0=20;
	LCD_DrawLine(x0,y0,x0+50,y0,Yellow);
	LCD_DrawLine(x0,y0,x0,y0+50,Yellow);
	LCD_DrawLine(x0,y0+50,x0+50,y0+50,Yellow);
	LCD_DrawLine(x0+50,y0,x0+50,y0+50,Yellow);
	x0=190;
	y0=30;
	LCD_DrawLine(x0,y0,x0+10,y0,Yellow);
	LCD_DrawLine(x0+20,y0,x0+30,y0,Yellow);
	LCD_DrawLine(x0,y0,x0,y0+30,Yellow);
	LCD_DrawLine(x0,y0+30,x0+30,y0+30,Yellow);
	LCD_DrawLine(x0+30,y0,x0+30,y0+30,Yellow);
	
	LCD_DrawLine(x0+15,y0-5,x0+15,y0+5,Yellow);
	
	GUI_Text(20,20, (uint8_t *) "Press here to enter",Yellow,Black);
	GUI_Text(20,40, (uint8_t *) "maintenance mode",Red,Black);
	
}
void DrawManagementPanel(void){
	//funzione che disegna il maintenancepanel
	LCD_Clear(Blue);
	GUI_Text(77,15, (uint8_t *) "Maintenance",Yellow,Blue);
	GUI_Text(67,60, (uint8_t *) "Select Note 1",White,Blue);
	GUI_Text(77,100, (uint8_t *) NameNote[13],White,Blue);
	GUI_Text(77,100, (uint8_t *) NameNote[note1],White,Blue);
	
	GUI_Text(45,130, (uint8_t *) "__________________",White,Blue);
	
	GUI_Text(67,160, (uint8_t *) "Select Note 2",White,Blue);
	GUI_Text(75,200, (uint8_t *) NameNote[13],White,Blue);
	GUI_Text(75,200, (uint8_t *) NameNote[note2],White,Blue);
	
	/*****************SAVE BUTTON**************************/
	GUI_Text(20, 260, (uint8_t *) "      ", White, Green);
	GUI_Text(20, 280, (uint8_t *) "      ", White, Green);
	GUI_Text(20, 270, (uint8_t *) " SAVE ", White, Green);
	
	/****************QUIT BUTTON*************************/
	GUI_Text(170, 260, (uint8_t *) "      ", White, Red);
	GUI_Text(170, 280, (uint8_t *) "      ", White, Red);
	GUI_Text(170, 270, (uint8_t *) " QUIT ", White, Red);
	
	
}
void ButtonSelection(){
//funzione di selezione dei bottoni
	switch (nbutton){
		case 1:
			//button SAVE
			GUI_Text(20, 260, (uint8_t *) "      ", White, White);
			GUI_Text(20, 280, (uint8_t *) "      ", White, White);
			GUI_Text(20, 270, (uint8_t *) " SAVE ", Green, White);
			
			break;
		case 2:
			//button QUIT
			GUI_Text(170, 260, (uint8_t *) "      ", White, White);
			GUI_Text(170, 280, (uint8_t *) "      ", White, White);
			GUI_Text(170, 270, (uint8_t *) " QUIT ", Red, White);
			break;
		case 3:
			//button Select 1
			GUI_Text(67,60, (uint8_t *) "Select Note 1",Blue,White);
			GUI_Text(77,100, (uint8_t *) NameNote[note1],Blue,White);
			break;
		case 4:
			//button Select 2
			GUI_Text(67,160, (uint8_t *) "Select Note 2",Blue,White);
			GUI_Text(75,200, (uint8_t *) NameNote[note2],Blue,White);
			break;
		
	}
}
void ButtonDeselection(){
	//funzione di deselezione dei bottoni
switch(nbutton){
	case 1:
			//button SAVE
			GUI_Text(20, 260, (uint8_t *) "      ", White, Green);
