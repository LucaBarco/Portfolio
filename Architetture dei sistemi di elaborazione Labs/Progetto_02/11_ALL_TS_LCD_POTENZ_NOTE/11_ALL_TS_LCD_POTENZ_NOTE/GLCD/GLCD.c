...
extern int note; //indice per accedere al vettore delle note (frequenze+messaggi)
...
void DrawManagementPanel(void){
	...
	GUI_Text(77,100, (uint8_t *) NameNote[note],White,Blue);
	...
	GUI_Text(75,200, (uint8_t *) NameNote[note],White,Blue);
