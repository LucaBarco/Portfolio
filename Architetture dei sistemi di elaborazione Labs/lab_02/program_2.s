...
loop: l.d F1, v1(R1) ;  FDEMW +1
      ...
      div.d F6,F9,F5 ;          FDDDDDSSSSSEEEEEEEEEEEEEEEEEEEEEEEEMW +24
      s.d F5,v5(R1) ;            FDSSSSSSSSEMW
      s.d F6,v6(R1) ;             FSSSSDSSSSSSSSSSSSSSSSSSSSSSSSSSSEMW +1
      daddui R1,R1,8 ;                     FFFFDSSSSSSSSSSSSSSSSSSSSEMW +1
bne R1,R2,loop ;                                                   FDDEMW  +2   (stallo nella fase di decode perchè R1 non è ancora scritto (read after write- raw))        
halt ;                                                                      +1 (*30 volte)

;6+(30*46)=1386 DA EXEC -> 1386
;cambiando le configurazioni i cicli diventano: 1) 1326 2)1266 3)1026
;
;   1)1326 (44 cc a ciclo)  (miglioramento di 2 cc per ciclo a fronte di un miglioramento della add di 3 cc)
;   2)1266 (42 cc a ciclo)  (miglioramento di 4 cc per ciclo a fronte di un miglioramento della mul di 4 cc)
;   3)1026 (34 cc a ciclo)  (miglioramento di 12 cc per ciclo a fronte di un miglioramento della div di 12 cc)
;
; nel caso 1) non si ha un guadagno in termini di cc pari al miglioramento dovuto alla singola istruzione 
;                               --> ciò rende il risultato sperimentale diverso da quello calcolato con la legge di Amdahl
