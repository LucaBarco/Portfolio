...
loop: l.d F1, v1(R1) ;  FDEMW +1
      ...
      l.d F4, v4(R1) ;      FDEMW
      l.d F7, v3(R1) ;       FDEMW
      mul.d F9,F3,F4 ;        FDEEEEEEEEMW +3
      add.d F5,F8,F7 ;         FDSSSSEEEEMW +1
      dadd R3,R0,R1;            FDEMW
      daddui R1,R1,8;            FDEMW
      div.d F6,F9,F5 ;            FDDDSSSEEEEEEEEEEEEMW +12
      s.d F5,v5(R3) ;                FDSSSSSSEMW
      s.d F6,v6(R3) ;                    FFFFDSSSSSSSEMW +1
bne R1,R2,loop ;                                   FDEMW  +1  
nop;                                                FDEMW +1 (*30 volte)
halt ;                                        +1 


; 6+(30*30)+1=907 --> DA EXEC=907