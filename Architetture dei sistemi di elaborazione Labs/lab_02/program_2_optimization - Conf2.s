...
loop: l.d F1, v1(R1) ;  FDEMW +1
      ...
      mul.d F8,F1,F2 ;     FDEEEEMW (+4)(+8) 
      l.d F4, v4(R1) ;      FDEMW
      l.d F7, v3(R1) ;       FDEMW
      add.d F5,F8,F7 ;        FDSEEEEEEMW +6
      mul.d F9,F3,F4 ;         FDEEEEMW        INIZIA SUBITO perchè sono vuoti gli stadi della pipeline
      div.d F6,F9,F5 ;          FDDDDDSEEEEEEEEEEEEEEEEEEEEEEEEMW +24 
      s.d F5,v5(R1) ;            FDSSSSEMW
      s.d F6,v6(R1) ;             FSSSSDSSSSSSSSSSSSSSSSSSSSSSSEMW +1
