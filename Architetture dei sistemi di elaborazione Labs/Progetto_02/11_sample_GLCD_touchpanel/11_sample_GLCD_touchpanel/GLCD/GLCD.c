...
void ButtonSelection(){
	...
	switch (nbutton){
		...
		case 3:
			...
			GUI_Text(77,100, (uint8_t *) "440 Hz - A",Blue,White);
			break;
		case 4:
			//button Select 2
			GUI_Text(67,160, (uint8_t *) "Select Note 2",Blue,White);
			GUI_Text(75,200, (uint8_t *) "440 Hz - A",Blue,White);
			break;
